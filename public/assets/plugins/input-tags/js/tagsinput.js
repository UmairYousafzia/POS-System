...
(function ($) {
  ...
  TagsInput.prototype = {
    ...
    add: function(item, dontPushVal, options) {
      ...
      var $tag = $('<span class="' + htmlEncode(tagClass) + (itemTitle !== null ? ('" title="' + itemTitle) : '') + '">' + htmlEncode(itemText) + '<span data-roles="remove"></span></span>');
      $tag.data('item', item);
    ...
    build: function(options) {
      ...
      // Remove icon clicked
      self.$container.on('click', '[data-roles=remove]', $.proxy(function(event) {
        if (self.$element.attr('disabled')) {
          return;
        }
    ...
    destroy: function() {
      ...
      self.$container.off('click', '[roles=remove]');
   ...
   * data-roles=tagsinput
   */
  $(function() {
    $("input[data-roles=tagsinput], select[multiple][data-roles=tagsinput]").tagsinput();
  });
})(window.jQuery);
